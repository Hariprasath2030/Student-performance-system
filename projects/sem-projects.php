...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Semester Project pages </title>
    <!-- Boxiocns CDN Link -->
  ...
  align-items: center;
  background-image:radial-gradient(rgba(238, 235, 235, 0), rgb(48, 42, 42)), url(oooo.jpg);
...
p{
  ...
  <nav>
      <div class="logo">SEMESTER PROJECTS</div>
      ...
      <ul>
        <li>
          ...
          <a href="semproj-1/proj-1.php">SEM 1</a>
        </li>
        <li>
          <label for="btn-2" class="show-1">SEM 2 +</label>
          <a href="semproj-2/proj-2.php">SEM 2</a>
        </li>
        <li>
          <label for="btn-1" class="show-1">SEM 3 +</label>
          <a href="semproj-3/proj-3.php">SEM 3</a>
         </li>
        <li>
...
<section class="home-section">
    <div class="text-box">
    <h1>DEPARTMENT<br>OF<br><span>IT-PROJECT DETAILS</span></h1>         
        </div>
  </section>
