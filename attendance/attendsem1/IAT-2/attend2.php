...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE att_2 SET Tamil='$tamil', English='$english', CTPS='$ctps', Maths='$maths', ITES='$ites', Economics='$economics', Attendance_Percentage='$totalAttendance' WHERE id='$studentId'";
...
<html lang="en">
<head>
<title>IT Attendance sem-1 IAT-2</title>
<style>
        nav {
        background: #1b1b1b;
        padding: 10px 0;
