...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE att_3 SET ADB='$adb', AJP='$ajp', ES='$es', Maths='$maths', OS='$os', BM='$bm', DAA='$daa', Attendance_Percentage='$totalAttendance' WHERE id='$studentId'";
...
<html lang="en">
<head>
<title>IT Attendance sem-4 IAT-3</title>
<style>
        nav {
        background: #1b1b1b;
        padding: 10px 0;
