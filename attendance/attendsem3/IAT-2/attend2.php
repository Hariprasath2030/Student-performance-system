...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE att_2 SET Tamil='$tamil', ADS='$ads', DBT='$dbt', Maths='$maths', OOPS='$oops', MPMC='$mpmc',WS ='$ws', Attendance_Percentage='$totalAttendance' WHERE id='$studentId'";
...
<html lang="en">
<head>
<title>IT Attendance sem-3 IAT-2</title>
<style>
        nav {
        background: #1b1b1b;
        padding: 10px 0;
