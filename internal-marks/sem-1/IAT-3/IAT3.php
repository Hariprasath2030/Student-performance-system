...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE iat3 SET Tamil='$tamil', English='$english', CTPS='$ctps', Maths='$maths', ITES='$ites', Economics='$economics' WHERE id='$studentId'";
