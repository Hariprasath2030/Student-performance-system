...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['edit'])) {
        ...
        $result = $con->query("SELECT * FROM iat2 WHERE id='$selectedStudentId'");
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE iat2 SET Tamil='$tamil', English='$english', PDS='$PDS', Maths='$Maths', CO='$CO', WP='$WP',  DPSD='$DPSD' ,  Psycho='$Psycho' WHERE id='$studentId'";
    ...
    if (isset($_POST['add'])) {
        ...
        $insertQuery = "INSERT INTO iat2 (name, roll_no) VALUES ('$newStudentName', '$newStudentRollNo')";
...
<nav>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <div class="container">
        ...
        $result = $con->query("SELECT * FROM iat2");
