...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['save'])) {
        foreach ($_POST['students'] as $studentId => $details) {
            ...
            $updateQuery = "UPDATE iat1 SET Tamil='$tamil', English='$english', PDS='$PDS', Maths='$Maths', CO='$CO', WP='$WP',  DPSD='$DPSD' ,  Psycho='$Psycho' WHERE id='$studentId'";
